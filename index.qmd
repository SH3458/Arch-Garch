...
-   Aim = Model the conditional variance of a TS as a function of its own past values. ![](images/Screenshot%202024-05-02%20075803.png)
...
-   Also allows long memory and flexible lag structure.
    ...
    ![](images/Screenshot 2024-05-02 075919.png)
...
4.  Interpretation: Reject the null hypothesis if the test statistic exceeds the critical value from a chi-square distribution with q degrees of freedom.
This test helps determine whether the squared residuals exhibit significant autocorrelation, indicating the presence of ARCH effects in the data.
